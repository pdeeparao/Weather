...
class SummaryAdapter(private val onItemClickListener: OnSummaryItemClickListener) :
    ...
    class SummaryViewHolder(itemView: View) : ViewHolder(itemView) {
        ...
        fun bind(
            weatherDataResource: Resource<WeatherData>,
            pos: Int,
            onItemClickListener: OnSummaryItemClickListener
        ) {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): RecyclerView.ViewHolder {
        val summaryItem =
            LayoutInflater.from(parent.context).inflate(R.layout.item_summary_city, parent, false)
